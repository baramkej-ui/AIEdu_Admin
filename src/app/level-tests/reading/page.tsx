...
export default function ReadingTestPage() {
  ...
  return (
    <ProtectedPage allowedRoles={["admin", "teacher"]}>
      <PageHeader
        title="Reading Level Test Settings"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set the total time in minutes that students have to complete the Reading level test.
          </CardDescription>
        </CardHeader>
        <CardContent>
            {isDataLoading ? (
      ...
      <Card className="mt-6">
        <CardHeader className="flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Problems included in the Reading level test. There are {testProblems.length} problems in total.
            </CardDescription>
          </div>
